...
const routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'project',
        component: View,
        redirect: { name: 'notes.index' },
        children: [
          {
            path: 'notes',
            name: 'notes.index',
            component: () => import('@cruds/Notes/Index.vue'),
            meta: { title: 'cruds.note.title' }
          },
          {
            path: 'notes/create',
            name: 'notes.create',
            component: () => import('@cruds/Notes/Create.vue'),
            meta: { title: 'cruds.note.title' }
          },
          {
            path: 'notes/:id',
            name: 'notes.show',
            component: () => import('@cruds/Notes/Show.vue'),
            meta: { title: 'cruds.note.title' }
          },
          {
            path: 'notes/:id/edit',
            name: 'notes.edit',
            component: () => import('@cruds/Notes/Edit.vue'),
            meta: { title: 'cruds.note.title' }
          },
          {
            path: 'documents',
            name: 'documents.index',
            component: () => import('@cruds/Documents/Index.vue'),
            meta: { title: 'cruds.document.title' }
          },
          {
            path: 'documents/create',
            name: 'documents.create',
            component: () => import('@cruds/Documents/Create.vue'),
            meta: { title: 'cruds.document.title' }
          },
          {
            path: 'documents/:id',
            name: 'documents.show',
            component: () => import('@cruds/Documents/Show.vue'),
            meta: { title: 'cruds.document.title' }
          },
          {
            path: 'documents/:id/edit',
            name: 'documents.edit',
            component: () => import('@cruds/Documents/Edit.vue'),
            meta: { title: 'cruds.document.title' }
          }
        ]
      },
      {
        ...
        name: 'task',
        component: View,
        redirect: { name: 'infos.index' },
        children: [
          {
            path: 'infos',
            name: 'infos.index',
            component: () => import('@cruds/Infos/Index.vue'),
            meta: { title: 'cruds.info.title' }
          },
          {
            path: 'infos/create',
            name: 'infos.create',
            component: () => import('@cruds/Infos/Create.vue'),
            meta: { title: 'cruds.info.title' }
          },
          {
            path: 'infos/:id',
            name: 'infos.show',
            component: () => import('@cruds/Infos/Show.vue'),
            meta: { title: 'cruds.info.title' }
          },
          {
            path: 'infos/:id/edit',
            name: 'infos.edit',
            component: () => import('@cruds/Infos/Edit.vue'),
            meta: { title: 'cruds.info.title' }
          }
        ]
      },
