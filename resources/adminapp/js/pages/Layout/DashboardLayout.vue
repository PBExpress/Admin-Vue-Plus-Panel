    ...
    return {
      sidebarLinks: [
        ...
        },
        {
          ...
          children: [
            {
              title: 'cruds.note.title',
              icon: 'table_view',
              path: { name: 'notes.index' },
              gate: 'note_access'
            },
            {
              title: 'cruds.document.title',
              icon: 'table_view',
              path: { name: 'documents.index' },
              gate: 'document_access'
            }
          ]
        },
        {
          ...
          children: [
            {
              title: 'cruds.info.title',
              icon: 'table_view',
              path: { name: 'infos.index' },
              gate: 'info_access'
            }
          ]
        },
